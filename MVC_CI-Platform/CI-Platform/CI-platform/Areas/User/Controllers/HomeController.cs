...
namespace CI_platform.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        [Route("Home")]
        public JsonResult home(List<string> countries, List<string> cities, List<string> themes, List<string> skills, string key, string sort_by, int page_index, long user_id, long Mission_id, string request_for)
        {
            if (page_index != 0)
            {
