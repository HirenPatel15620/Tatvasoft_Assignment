...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=PCA138\\SQL2017;Initial Catalog=CI-Platform;Persist Security Info=False;User ID=sa;Password=Tatva@123;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=False;Connection Timeout=30;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Mission>(entity =>
        {
            ...
            entity.Property(e => e.Title)
                ...
                .IsUnicode(false)
                .HasColumnName("title");
            entity.Property(e => e.TotalMission).HasColumnName("total_mission");
            entity.Property(e => e.UpdatedAt)
                .HasColumnType("datetime")
                .HasColumnName("updated_at");
        ...
        modelBuilder.Entity<MissionSkill>(entity =>
        {
            ...
            entity.HasOne(d => d.Skill).WithMany(p => p.MissionSkills)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_mission_skill_mission_skill1");
        });
